	...
	methods = {
        ...
        close: function (o, urls) { //关闭弹框
	    	...
	    	function _effect() {
				...
				$(this).removeAttr('class').addClass("dialog").removeAttr('style').addClass('animated').hide(); 
