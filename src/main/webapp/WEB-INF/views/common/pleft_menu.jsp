...
<div class="uCEN-L funlist_left">
	<div class="fun_profile">
        <div class="fnro_title"><i></i><a href="<%=resource_url%>ucenter/core/personalCenter.do">用户中心首页</a></div> 
        <ul class="uCEN-nav">
        ...
        <ul class="uCEN-nav">
	        ...
	        <li id="m-goodlibrary"><a href="<%=resource_url%>goodlibrary/gotoOpenGoodLibrary.do" target="_blank">我的善库<i></i></a></li>
        </ul>
        ...
        <ul class="uCEN-nav">
	        ...
	        <li id="realtionProject"><a href="#">相关项目<i></i></a></li>
        </ul>
