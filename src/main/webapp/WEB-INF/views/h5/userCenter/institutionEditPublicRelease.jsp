...
<body>
	<div class="red redLeft">
		...
		<div class="red_center1 red_center2">
			<p class="center_p1">项目标题:</p>
			<input type="text" placeholder="" class="center_inp1" id="title"
				value="${project.title}"> <span class="center_sp1"></span>
		</div>
		<div class="red_center1 red_center2">
			<p class="center_p1">目标金额:</p>
			<input type="text" placeholder="" class="center_inp1"
		...
		<div class="red_center1 red_center2">
			<p class="center_p1">募捐时间:</p>
			<input type="number" placeholder="默认为30天" class="center_inp1"
	...
	<script
		data-main="<%=resource_url%>res/js/h5/releaseProject/institutionEditPublicRelease.js"
