...
<body>
	...
	<div class="red">
		<div class="red_center1 red_center2">
		    <input type="text" placeholder="项目标题" maxlength="20" class="center_inp1 center_inpp"  id="title" value="${project.title}">
		    <span class="center_sp1"></span>
		</div>
		<div class="red_center1 red_center2">
		    <input type="text" placeholder="目标金额" class="center_inp1 center_inpp" id="cryMoney" value="<fmt:formatNumber value="${project.cryMoney}" pattern="0.00"/>" onKeyUp="(this.v=function(){this.value=this.value.replace(/[^0-9.]+/,'');}).call(this)">
		    <span class="center_sp1">元</span>
		</div>
		<div class="red_center1 red_center2">
		    <input type="number"placeholder="募捐时间默认为30天" class="center_inp1 center_inpp" id="donateTime" value="" onkeyup="this.value=this.value.replace(/D/g,'')" onafterpaste="this.value=this.value.replace(/D/g,'')">
		    <span class="center_sp1">天</span>
		</div>
		
	    <div class="red_centerfl">
	        <textarea name="textArea1" class="textArea1" id="content" placeholder="项目内容：${atc.model }"></textarea>
	    </div>
