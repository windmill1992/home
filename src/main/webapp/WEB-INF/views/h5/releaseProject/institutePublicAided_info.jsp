...
<body>
	...
	<div class="bind_b1">
	    <div class="bind_fr1 release_fr1">
	        <input type="text" placeholder="请输入受助群体名称" id="relation" class="release_in"  value="">
	    </div>
	</div>
	<div class="bind_b1">
	    <div class="bind_fr1 release_fr1">
	        <input type="text" placeholder="请输入受助群体联系人姓名" name="appealName" class="release_in" id="appealName"  value="">
	    </div>
	</div>
	<div class="bind_b1">
	    <div class="bind_fr1 release_fr1">
	        <input type="text" placeholder="请输入受助群体联系人身份证" class="release_in" name="appealIdcard" id="appealIdcard"  value="${szr.Idcard}">
	    </div>
	</div>
	<div class="bind_b1">
	    <div class="bind_fr1 release_fr1">
	        <input type="text" placeholder="请输入受助群体联系人联系电话" class="release_in" name="appealPhone" id="appealPhone"  value="${szr.Phone}">
	    </div>
	</div>
    <div class="bind_b1">
	    <div class="bind_fr1 release_fr1">
	...
	<div class="bind_b1">
	    <div class="bind_fr1 release_fr1">
	        <input type="text" placeholder="请输入发布人QQ/微信" class="release_in" name="weixin" id="weixin" value="${szr.weixin}">
	    </div>
	</div>
	<p class="form_text">上传受助人身份证(正面、反面以及手持身份证三张)、机构与个人关系以及委托证书</p>
	...
	<input type="hidden" id="frontUserId" name="frontUserId" value="${frontUserId }" />
	...
	<script type="text/javascript">
	     function back(){
	         ...
	         url=url+"?frontUserId="+frontUserId+"&helpType="+helpType;
	         $("#back").attr("href",url);
	     }
	</script>
	<script type="text/javascript">
