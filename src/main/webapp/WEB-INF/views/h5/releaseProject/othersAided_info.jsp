...
<style type="text/css">
	.addList .item,.addList .item-model{
...
<body>
	...
	<div class="bind_b1">
	    <div class="bind_fr1 release_fr1">
	        <input type="text" placeholder="请输入受助人身份证号" class="release_in" name="appealIdcard" id="appealIdcard"  value="">
	    </div>
	</div>
	<div class="bind_b1">
	    <div class="bind_fr1 release_fr1">
	        <input type="text" placeholder="请输入电话号码" class="release_in" name="appealPhone" id="appealPhone"  value="">
	    </div>
	</div>
    <div class="bind_b1">
	    <div class="bind_fr1 release_fr1">
    ...
    <p class="form_text">请上传受助人委托证书。<!--<a href="" class="underline">查看样例</a>--></p>
			...
			<div class="addList" id="imgList1">
				<div class="item-model">
					<a href="javascript:;" class="preview">
						<img src="/res/images/releaseProject/zpt2.png"/>
					</a>
					<p class="txt">查看样例</p>
				</div>
