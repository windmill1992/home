...
<body>
	...
	<div class="pay_nc">
	<p>认捐项目：<span>${pcount}</span>个</p>

	</div>
	<div class="pay_nc">
	<p>认捐金额：<span>${perMoney}</span>元</p>
	</div>
	<div class="pay_nc">
	<p>合计：<span>${amount}</span>元</p>
	</div>
	...
	<script type="text/javascript">
		...
		function pay() {
			wx.chooseWXPay({
				...
				success : function(res) {
					...
					window.location.href = "http://www.17xs.org/ucenter/userCenter_h5.do";
				}
			});
		}
		function alipay()
		{
			...
			var touristMobile = $('#touristMobile').html();
			var plistId = $('#plistId').val();
			var extensionPeople = $('#extensionPeople').val();
			var projectId = $('#projectId').val();
			var amount = $('#amount').val() ;
			var copies = $("#copies").val();
			var url = base+"batchWapAlipay/deposit.do?projectId="
							+projectId+"&amount="+amount
							+"&payType=5" +"&copies="+copies
