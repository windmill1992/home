...
<body>
	...
	<nav>
		<div class="nav">
			<ul>
				...
				<a href="http://www.17xs.org/h5News/news_view.do?type=活动" id="hd"><li class="on">活动</li></a>
	...
	<div class="activity-body mui-content mui-scroll-wrapper scroll">
		<div class="activity-list scroll-list mui-scroll">
