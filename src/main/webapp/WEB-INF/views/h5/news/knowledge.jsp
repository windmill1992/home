...
<body>
	...
	<nav>
		<div class="nav">
			<ul>
				<a href="http://www.17xs.org/h5News/news_view.do?type=慈善知识" id="cszs"><li class="on">慈善知识</li></a>
				...
				<a href="http://www.17xs.org/h5News/news_view.do?type=公告" id="gonggao"><li>公告</li></a>
				<a href="http://www.17xs.org/h5News/news_view.do?type=爱心故事" id="axgs"><li>爱心故事</li></a>
			</ul>
		</div>
	</nav>
	<div class="knowledge-body mui-content mui-scroll-wrapper scroll">
		
		<div class="knowledge-list mui-scroll scroll-list">
