...
<link rel="stylesheet" type="text/css" href="<%=resource_url%>res/css/dev/indexjianyi.css">
</head> 
...
<!--主体 start-->
 ...
 <div class="jianyidenglu_box">
  ...
  <a  class="denglujian" href="http://www.17xs.org/user/sso/login.do?entrance=%20http%3A%2F%2Fwww.17xs.org%2Findex%2FtoAddService.do?type=1">登录</a></span>，登录后以便您查看投诉回复进度。</span>
  </div>
 </div></c:if>
 <div class="neirong">
 <ul>
   <li class="bitian" style="color:#ff0000;margin-top:1px;font-weight:bold;font-size:14px;margin-right:10px;">*</li>
   <li class="jy_neirong">建议内容 :</li>
   <li class="jy_tx"><textarea class="neiroujy_1" id="content" placeholder="我们非常重视您的建议，请在这里告诉我们，为确保您的个人信息安全，请勿在内容中填写个人账户、密码、联系方式等信息。"></textarea></li>
 </ul>
 </div>
 ...
 <div class="xingming">
   <ul>
     <li class="bitian" style="color:#ff0000;margin-top:1px;font-weight:bold;font-size:14px;margin-right:10px;">*</li>
     <li class="jy_xingming">我的姓名 :</li>
     <li class="jy_xingming_tx"><input placeholder="请输入您的真实姓名" id="user_txt" name="author" class="yourname" value="" type="text"></li>
   </ul>
 </div>
 ...
 <div  class="lianxi">
   <ul>
     <li class="bitian" style="color:#ff0000;margin-top:1px;font-weight:bold;font-size:14px;margin-right:10px;">*</li>
     <li class="jy_lianxi">我的联系方式 ：</li>
     <li class="jy_lianxi_tx1"><input placeholder="请输入您的电话/QQ/微信" id="phone_txt" name="phone_number" class="cellphone" value="" type="text"></li>
 ...
 <div class="yanzheng">
   <ul>
     <li class="jy_yanzheng">验证码 :</li>
     <li class="jy_yanzheng_tx"><input class="yanzhengnumber" value="" type="text" id="codeNum"></li>
 ...
 <div class="tijiao_box">
   <a class="tijiao_ts" id="tijiao_ts">提交建议</a>
