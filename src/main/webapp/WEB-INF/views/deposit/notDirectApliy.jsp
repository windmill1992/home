...
<link rel="stylesheet" type="text/css" href="<%=resource_url%>res/css/dev/headNew.css?v=20160310"/>
</head> 
<body>
...
<!--	                    <div class="tsxx_1">您还没有填写捐款金额</div>-->
            ...
            <div class="p_2">感谢您的无私支持，为了提供更好的服务，我们希望您能留下姓名和联系方式，<a href="#"  id = "gDtile-btn" >点此登录网站</a></div>
            <div class="p_3">
              <div class="xmdh">姓名：<input name="touristName"  id = "touristName" type="text" /></div>
              <div class="xmdh">手机：<input name="touristMobile" id = "touristMobile" type="text" /></div>
            </div>
		</div>
        ...
        <div class="page-bd page-entBd">
            ...
            <div class="pay-chd">
                <ul class="pay-tit">
                    <li class="name">认捐主题：${pName}</li>
                    <li>还需要捐款:<span class="smoney" id="Smoney" data="${amount}">${amount}</span>元</li>
                </ul>
                <div class="pay-money">
                	我要认捐<input type="text" id="Cmoney" placeholder="请输入认捐金额" onkeyup="(this.v=function(){this.value=this.value.replace(/[^0-9.]+/,'');}).call(this)"/> 元
                </div>
            </div>
           -->
            	<div class="pay-hdm">
...
-->
<script data-main="<%=resource_url%>res/js/dev/entVisitorPay.js" src="<%=resource_url%>res/js/require.min.js"></script>
</body>
</html>