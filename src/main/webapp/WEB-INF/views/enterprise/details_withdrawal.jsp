...
<body>
            ...
            <div class="uCEN-R"> 
                <div class="charge-menu">
                    <ul>
                        ...
                        <li class="active">
                            <a href="<%=resource_url%>enterprise/core/entDetailsWithdrawal.do">提款明细</a>
                        </li>
                    </ul>
                </div>
	...
	<script data-main="<%=resource_url%>res/js/dev/details_withdrawal.js" src="<%=resource_url%>res/js/require.min.js"></script>
</body>
</html>
