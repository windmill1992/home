	...
	<div class="page"> 
        <div class="page-bd">
            ...
            <div class="uCEN-R"> 
                <div class="enfState">
                	<h2>企业认证</h2>
                    <div class="enfSbox enfError">
                    	<div class="enfTle">审核失败，认证资料有误，请确认后  <a href="<%=resource_url%>enterprise/core/updateRealName.do" title="">  重新认证</a>  。若有疑问，请联系在线客服。   </div>
                        <div class="enfCon">
                        	<div class="enfgroup">
                                <label>企业注册号：</label>
                            ...
                            <div class="enfgroup enfErrText">${back.reviewContent}</div>
                        </div>
                      </div>
                </div>
            </div>
