...
<div class="bodyer pay notPay">
	<div class="page">
    	...
    	<div class="page-hd">
           <div class="page-tit"><h2 class="w1000">企业助善</h2></div>
        </div>
        <div class="page-bd"> 
            <div class="pay-hdm yh">
            	<h2>助善信息</h2>
                <ul class="pay-tit">
                    <li><em>*</em>项目名称：${title}</li>
                    <li><em>*</em>助善方式：每号召1人注册，企业助捐 <input type="text"  class="text" id="donateMoney" onKeyUp="(this.v=function(){this.value=this.value.replace(/[^0-9.]+/,'');}).call(this)"> 元</li>
                    <li><em>*</em>助善预算总额： <input type="text"  class="text" id="sumMoney" onKeyUp="(this.v=function(){this.value=this.value.replace(/[^0-9.]+/,'');}).call(this)">(预算款将冻结在企业账户资金内，针对新注册网友实时助捐，若捐款已满或助善终止，剩余预算款退回账户)</span></li>
                    <li class="orangePrim">您的助善将会有     <span id="joinNum">0</span>  人加入我们，一起行善！感谢有你！</li>
                </ul>
                <h2>支付确认</h2>
                <ul class="pay-tit">
                    <li>助善主题：${title}</li>
...
<input type="hidden"  id="usableMoney" value="${balance}"/>
<input type="hidden"  id="title" value="${title}"/>
<input type="hidden"  id="NeedMoney" value="<fmt:formatNumber value="${project.cryMoney - project.donatAmount}" pattern="0.00"/>" />
 <%@ include file="./../common/footer.jsp" %>
<script data-main="<%=resource_url%>res/js/dev/entAlipay.js" src="<%=resource_url%>res/js/require.min.js"></script>
</body>
</html>
