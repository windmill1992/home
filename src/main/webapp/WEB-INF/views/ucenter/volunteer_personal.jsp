        ...
        <div class="uCEN-R invoice_right">
            ...
            <div class="volunteer_form changebox">
		        ...
		        <ul class="volunteer_thedetail">
		            ...
		            <li class="write_1">${pv.sex }</li>
		        </ul>
		        <ul class="volunteer_thedetail">
		            <li class="need"></li>
		            <li class="term">
		                <span class="term1" style="letter-spacing:8px;">职&nbsp;业</span>
		                <span class="term2">:</span>
		            </li>
		            <li class="write">${pv.position }</li>
		        </ul>
		        <ul class="volunteer_thedetail">
		            <li class="need"></li>
		            <li class="term">
		                <span class="term1">出生日期</span>
		                <span class="term2">:</span>
		            </li>
		            <li class="write">${pv.birthday }</li>
		        </ul>
		        <ul class="volunteer_thedetail">
		            <li class="need"></li>
		            <li class="term">
