...
<div class="bodyer userCenter legalizeOk">
	<div class="page"> 
        <div class="page-bd">
            ...
            <div class="uCEN-R">
                ...
                <div class="leprim">实名认证成功！您还可以 完善所在公司信息，加入企业善员工，一起行善</div>
                <div class="rlgroup">
                        <label>个人头像：</label>
                ...
                <div class="PerfectInfo">
                               ...
                               <select class="itemselect" id="companyId">
                                    ...
                                    <c:if test="${companys!=null}">
                                      <c:forEach items="${companys}" var="company" >
									        <option tel="${company.id}"  <c:if test="${employee.company_userId==company.id}">selected="selected"</c:if>>${company.userName}</option>
									  </c:forEach>
                                    </c:if>
                                    <option tel="0" 
                                    <c:if test="${employee.company_userId==0}"> selected="selected"</c:if>
                                    <c:if test="${myc!=null&&myc.state!=203}"> selected="selected"</c:if>
                                    >其它</option>
                                  </select>
                                  <input 
                                  <c:if test="${employee.company_userId!=0&&myc!=null&&myc.state==203}">style="display: none;"</c:if>
                                  value=" ${employee.companyName}" type="text" id="companyName" class="itemtext textmoney"  placeholder="输入正确公司名称，以便系统匹配至该企业善员工">
                               </div>
                            </div>
                    ...
                    <div class="rlgroup">
                            ...
                            <div class="controls controlsn leAdress">
                                ...
                                <div class="leDetail">
                                        <input type="text" id="detailAddress" class="itemtext textmoney" value="${employee.address}">
                                   </div>
                        ...
                        <div class="rlitem rlitemUrl mt15">
                            ...
                            <div class="rltext">
                                <div class="rlinput">
                                    <input type="text" value=" ${employee.position}" id="postion" placeholder=""/>
                                </div>
 ...
 <input type="hidden" id="location" value="${employee.province}">
<%@ include file="./../common/newfooter.jsp" %>
<script data-main="<%=resource_url%>res/js/dev/my_LegalizeEdit.js" src="<%=resource_url%>res/js/require.min.js"></script>
</body>
</html>