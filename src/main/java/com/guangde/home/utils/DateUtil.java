...
public abstract class DateUtil {
    ...
    /*** 一分钟秒表示 */
    public static final long DURATION_MIN_S = 1*1*1*60l;//秒
    /*** 五分钟秒表示 */
    public static final long DURATION_FIVE_S = 1*1*5*60l;//秒
    /*** 十分钟秒表示 */
    public static final long DURATION_TEN_S = 1*1*10*60l;//秒
    /*** 一小时秒表示 */
    public static final long DURATION_HOUR_S = 1*1*60*60l;//秒	
    /*** 一天秒表示 */
    public static final long DURATION_DAY_S = 1*24*60*60l;//秒
    /*** 一周秒表示 */
    public static final long DURATION_WEEK_S = 7*24*60*60l;//秒
    /**一月秒表示*/
    public static final long DURATION_MONTH_S = 30*24*60*60l;//秒
    ...
    * @return
    */
    public static long millisecondBetween(Date compareTime, Date currentTime) {
        if (compareTime == null || currentTime == null)
            return 0;
        return compareTime.getTime() - currentTime.getTime();
    }
...
//    	}
     ...
     * @return String, 返回格式化的日期字符串
     */
    public static String dateStringChinesePatternYD(String fm, Date def) {
        SimpleDateFormat sdf = new SimpleDateFormat(fm);
        return sdf.format(def).substring(5, 11);
    }
     ...
     * @return String, 返回格式化的日期字符串
     */
    public static String dateString2(Date def) {
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        return sdf.format(def).substring(0, 19);
    }
     ...
     * @return String, 返回格式化的日期字符串
     */
    public static String dateFormat(Date def) {
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        return sdf.format(def).substring(5,10);
    }
    /**
     * 输出格式化日期 yyyy
     *
    ...
    public static Date getCurrentDate() throws ParseException {
        ...
        String cday = format.format(new Date());
        cday += " 23:59:59";
        format = new  SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        return format.parse(cday);
    }
    /**
     * 获取当天开始时间
     * @return
    ...
    public static void main(String[] args) 
    {
    	 ...
    	 try {
			String date = format.format(getCurrentDate());
